...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/Dracolavip/Music",
)
UPSTREAM_BRANCH = getenv("UPSTREAM_BRANCH", "master")

GIT_TOKEN = getenv("GIT_TOKEN", None)

SUPPORT_CHANNEL = getenv("SUPPORT_CHANNEL", "https://t.me/I_O_ID")
SUPPORT_CHAT = getenv("SUPPORT_CHAT", "https://t.me/OU_ll1")
...
START_IMG_URL = getenv(
    "START_IMG_URL", "https://telegra.ph/file/f3e6ae4ab46ca33ccbd18.jpg"
)
PING_IMG_URL = getenv(
